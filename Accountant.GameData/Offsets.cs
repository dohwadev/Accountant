...
public static class Signatures
{
    ...
    //public const string AirshipTimers =
    //    "E8 17 03 00 00 33 D2 48 8D 4C 24 30 41 B8 90 00 00 00 E8 65 CA 8D 00 48 8D 54 24 30 48 8B CB E8 E8 03 00 00 B0 01 48";

    //public const string AirshipStatus =
    //    "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 20 48 8B D9 33 FF 48 8B 49 10 49 8B E9 48 85 C9 74 0C";

    public const string SubmersibleTimers = "E8 ?? ?? ?? ?? 48 8B 0D ?? ?? ?? ?? 48 85 C9 74 ?? E8 ?? ?? ?? ?? 84 C0 75";
    //public const string SubmersibleTimers = "E8 E8 03 00 00 B0 01 48 81 C4 10 01 00 00 5B C3";
