...
public sealed class SeStringMatcher : ILocMatcher
{
    ...
    public static SeStringMatcher SinglePayloadComparer(ClientLanguage lang, SeString s, Index idxEn, Index idxFr, Index idxJp, Index idxDe, Index idxKo)
    {
        var idx = lang switch
        {
