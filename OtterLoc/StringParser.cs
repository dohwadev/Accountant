...
public sealed class StringParser : ILocFilter
{
    ...
    public static StringParser FromRange(ClientLanguage lang, Range en, Range fr, Range jp, Range de, Range ko)
    {
    ...
    public static StringParser FromRegex(ClientLanguage lang, Regex en, Regex fr, Regex jp, Regex de, Regex ko, params string[] captureNames)
    {
